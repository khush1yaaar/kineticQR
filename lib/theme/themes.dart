...
class CustomTheme with ChangeNotifier {
  ...
  static ThemeData get lightTheme {
    return ThemeData(
      primaryColor: Colors.blue.shade400, // Primary color for the light theme.
      ...
      appBarTheme: AppBarTheme(
        backgroundColor: Colors.blue.shade400, // Background color for the AppBar.
      ...
      textTheme: TextTheme(
        ...
        headlineLarge: TextStyle(color: Colors.blue.shade400), // Large headline text color.
        headlineMedium: TextStyle(color: Colors.blue.shade400), // Medium headline text color.
        headlineSmall: TextStyle(color: Colors.blue.shade400), // Small headline text color.
